...
export const initializeThemeScript = `if (localStorage.getItem('theme') === 'dark' || window.matchMedia('(prefers-color-scheme: dark)').matches) { document.documentElement.classList.toggle('dark'); localStorage.setItem('theme', 'dark') }`
